...
public partial class LevelGenerator : MonoBehaviour
{
    ...
    public float explorationRewardWeight = 12f;
    public float directionalDiversityRewardWeight = 5f;
    public float oscillationPenaltyWeight = 10f;
    public float boundaryViolationPenaltyWeight = 25f;
    public float goalProgressRewardWeight = 2f;
    ...
    private Dictionary<Vector2i, int> ghostReplayTileVisitHeatmap = new Dictionary<Vector2i, int>();
    private Dictionary<int, int> ghostDirectionCounts = new Dictionary<int, int>();
    private List<int> recentGhostDirections = new List<int>();
